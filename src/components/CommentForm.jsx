...
const CommentForm = () => {
  ...
  return (
    <>
      <div
        className="d-flex m-2 p-2 comment_container flex-column border"
        style={
          isDarkMode ? {} : { background: "rgb(51,51,51)", color: "white" }
        }
      >
        {selectedTea.comments
          ? selectedTea.comments.map((comment) => (
      ...
      <form className="w-75 text-center" onSubmit={submitComment}>
        ...
        <div className="d-flex justify-content-center">
            <input
              type="submit"
              value="Comment"
              className="btn btn-success mt-2 mb-3 w-50"
              style={{ marginLeft: "" }}
            />
          </div>
      </form>
          <button
            ...
            onClick={() => setRenderDelete(!renderDelete)}
          >
            Edit
          </button> 
    </>
